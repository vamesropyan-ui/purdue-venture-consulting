...
const photos = [
  ...
  { src: '/lovable-uploads/rounds_present.jpeg', alt: 'Rounds consulting project team', cls: '' },
  { src: '/lovable-uploads/6b8e7100-ba33-4421-9726-8cdd8be82ee2.png', alt: 'PoliStock project team presenting', cls: '' },
