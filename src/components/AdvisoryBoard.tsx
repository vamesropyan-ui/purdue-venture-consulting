...
const AdvisoryBoard = () => {
  ...
  return (
    <section id="advisory-board" className="relative overflow-hidden py-20" style={{ background: 'linear-gradient(180deg, hsl(214 44% 97%) 0%, hsl(215 40% 95%) 100%)' }}>
      <div aria-hidden="true" className="pointer-events-none absolute inset-0" style={{ backgroundImage: 'radial-gradient(hsl(214 40% 55%) 1px, transparent 1.4px)', backgroundSize: '26px 26px', opacity: 0.1 }} />
